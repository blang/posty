// Generated on 2015-11-24 using generator-angular 0.8.0
'use strict';
    ...
    copy: {
      dist: {
        files: [{
          ...
          dest: '<%= yeoman.dist %>/static/bower_components/font-awesome',
          src: [
            'fonts/*'
          ]
        },{
          expand: true,
          dot: true,
          cwd: '<%= yeoman.app %>/static/bower_components/bootstrap',
          dest: '<%= yeoman.dist %>/static/bower_components/bootstrap',
          src: [
            'dist/fonts/*'
          ]
        },{
